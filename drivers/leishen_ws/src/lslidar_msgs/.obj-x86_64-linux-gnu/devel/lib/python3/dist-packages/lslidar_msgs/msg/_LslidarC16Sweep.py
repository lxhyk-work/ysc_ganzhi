...
"""autogenerated by genpy from lslidar_msgs/LslidarC16Sweep.msg. Do not edit."""
import codecs
import sys
...
class LslidarC16Sweep(genpy.Message):
  ...
  _type = "lslidar_msgs/LslidarC16Sweep"
...
"""
  ...
  _slot_types = ['std_msgs/Header','lslidar_msgs/LslidarScan[16]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.scans is None:
        self.scans = [lslidar_msgs.msg.LslidarScan() for _ in range(16)]
    else:
      self.header = std_msgs.msg.Header()
      self.scans = [lslidar_msgs.msg.LslidarScan() for _ in range(16)]
