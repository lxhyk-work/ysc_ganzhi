...
(cl:defmethod cl:initialize-instance :after ((m <LslidarC16Sweep>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LslidarC16Sweep)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lslidar_msgs-msg:<LslidarC16Sweep> is deprecated: use lslidar_msgs-msg:LslidarC16Sweep instead.")))
